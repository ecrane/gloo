...
class TellTest < BaseEngineTest

  def test_the_keyword
    assert_equal 'tell', GlooLang::Verbs::Tell.keyword
  end

  def test_the_keyword_shortcut
    assert_equal '->', GlooLang::Verbs::Tell.keyword_shortcut
  end
  ...
  def test_object_not_found
    ...
    assert @engine.error?
    msg = GlooLang::Verbs::Tell::OBJ_NOT_FOUND_ERR
  ...
  def test_unknown_msg
    ...
    assert @engine.error?
    assert_equal GlooLang::Verbs::Tell::UNKNOWN_MSG_ERR, @engine.heap.error.value
  end
