...
class CreateTest < BaseEngineTest
  ...
  def test_the_keyword
    assert_equal 'create', GlooLang::Verbs::Create.keyword
  end

  def test_the_keyword_shortcut
    assert_equal '`', GlooLang::Verbs::Create.keyword_shortcut
  end
  ...
  def test_object_creation_without_name
    ...
    assert @engine.error?
    assert_equal GlooLang::Verbs::Create::NO_NAME_ERR, @engine.heap.error.value
  end
