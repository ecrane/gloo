...
class ErbTest < BaseEngineTest

  def test_the_typename
    assert_equal 'erb', GlooLang::Objs::Erb.typename
  end

  def test_the_short_typename
    assert_equal 'erb', GlooLang::Objs::Erb.short_typename
  end
  ...
  def test_messages
    msgs = GlooLang::Objs::Erb.messages
    assert msgs
  ...
  def test_adds_children_on_create
    o = GlooLang::Objs::Eval.new @engine
