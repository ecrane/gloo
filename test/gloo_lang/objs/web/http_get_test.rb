...
class HttpGetTest < BaseEngineTest
  ...
  def test_the_typename
    assert_equal 'http_get', GlooLang::Objs::HttpGet.typename
  end

  def test_the_short_typename
    assert_equal 'get', GlooLang::Objs::HttpGet.short_typename
  end
  ...
  def test_messages
    msgs = GlooLang::Objs::HttpGet.messages
    assert msgs
  ...
  def test_adds_children_on_create
    o = GlooLang::Objs::HttpGet.new @engine
