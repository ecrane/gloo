...
class HttpPostTest < BaseEngineTest
  ...
  def test_the_typename
    assert_equal 'http_post', GlooLang::Objs::HttpPost.typename
  end

  def test_the_short_typename
    assert_equal 'post', GlooLang::Objs::HttpPost.short_typename
  end
  ...
  def test_messages
    msgs = GlooLang::Objs::HttpPost.messages
    assert msgs
  ...
  def test_adds_children_on_create
    o = GlooLang::Objs::HttpPost.new @engine
