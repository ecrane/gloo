...
class TeamsTest < BaseEngineTest

  def test_the_typename
    assert_equal 'teams', GlooLang::Objs::Teams.typename
  end

  def test_the_short_typename
    assert_equal 'team', GlooLang::Objs::Teams.short_typename
  end
  ...
  def test_messages
    msgs = GlooLang::Objs::Teams.messages
    assert msgs
  ...
  def test_adds_children_on_create
    o = GlooLang::Objs::Teams.new @engine
