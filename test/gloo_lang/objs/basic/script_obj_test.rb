...
class ScriptObjTest < BaseEngineTest

  def test_the_typename
    assert_equal 'script', GlooLang::Objs::Script.typename
  end

  def test_the_short_typename
    assert_equal 'cmd', GlooLang::Objs::Script.short_typename
  end
  ...
  def test_setting_the_value
    o = GlooLang::Objs::Script.new @engine
  ...
  def test_messages
    msgs = GlooLang::Objs::Script.messages
    assert msgs
