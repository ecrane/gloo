...
class BooleanTest < BaseEngineTest
  ...
  def test_the_typename
    assert_equal 'boolean', GlooLang::Objs::Boolean.typename
  end

  def test_the_short_typename
    assert_equal 'bool', GlooLang::Objs::Boolean.short_typename
  end
  ...
  def test_setting_the_value_to_true
    o = GlooLang::Objs::Boolean.new @engine
    o.set_value( 3 )
  ...
  def test_messages
    msgs = GlooLang::Objs::Boolean.messages
    assert msgs
