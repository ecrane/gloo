...
class ContainerTest < BaseEngineTest
  ...
  def test_the_typename
    assert_equal 'container', GlooLang::Objs::Container.typename
  end

  def test_the_short_typename
    assert_equal 'can', GlooLang::Objs::Container.short_typename
  end
  ...
  def test_messages
    msgs = GlooLang::Objs::Container.messages
    assert msgs
  ...
  def test_count_msg
    o = GlooLang::Objs::Container.new @engine
