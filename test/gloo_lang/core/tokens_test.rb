...
class TokensTest < BaseTest
  ...
  def test_tokenize_with_quotes_trailing_space
    o = GlooLang::Core::Tokens.new( '"space "' )
    assert o
  ...
  def test_token_count
    o = GlooLang::Core::Tokens.new( 'quit' )
    assert_equal 1, o.token_count
    o = GlooLang::Core::Tokens.new( '' )
    assert_equal 0, o.token_count
    o = GlooLang::Core::Tokens.new( 'create thing' )
  ...
  def test_one_param
    o = GlooLang::Core::Tokens.new( 'show me' )
    assert o
  ...
  def test_two_param
    o = GlooLang::Core::Tokens.new( 'show me more' )
    assert o
  ...
  def test_last_token
    ...
    o = GlooLang::Core::Tokens.new( 'one' )
    assert_equal 'one', o.last
    o = GlooLang::Core::Tokens.new( 'one two three 4 5' )
  ...
  def test_after_token
    o = GlooLang::Core::Tokens.new( 'create thing as string' )
    assert_equal 'string', o.after_token( 'as' )
    assert_equal 'string', o.after_token( 'AS' )
    o = GlooLang::Core::Tokens.new( 'AS string' )
    assert_equal 'string', o.after_token( 'as' )
    assert_equal 'string', o.after_token( 'AS' )
  end
  ...
  def test_before_token
    o = GlooLang::Core::Tokens.new( 'put 2 + 3 into x' )
    assert_equal 6, o.token_count
  ...
  def test_tokens_after
    o = GlooLang::Core::Tokens.new( 'if true then show 2 + 5' )
