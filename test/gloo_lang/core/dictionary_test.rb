...
class DictionaryTest < BaseEngineTest
  ...
  def test_unregistring_and_registring_verb
    assert_equal 'show', @dic.lookup_keyword( GlooLang::Verbs::Show.keyword )
    assert_equal 'show', @dic.lookup_keyword( GlooLang::Verbs::Show.keyword_shortcut )

    @dic.unregister_verb( GlooLang::Verbs::Show )

    refute @dic.lookup_keyword( GlooLang::Verbs::Show.keyword )
    refute @dic.lookup_keyword( GlooLang::Verbs::Show.keyword_shortcut )

    @dic.register_verb_post_start( GlooLang::Verbs::Show )
  ...
  def test_unregistring_and_registring_obj
    assert_equal 'text', @dic.lookup_keyword( GlooLang::Objs::Text.typename )
    assert_equal 'text', @dic.lookup_keyword( GlooLang::Objs::Text.short_typename )

    @dic.unregister_obj( GlooLang::Objs::Text )

    refute @dic.lookup_keyword( GlooLang::Objs::Text.typename )
    refute @dic.lookup_keyword( GlooLang::Objs::Text.short_typename )

    @dic.register_obj_post_start( GlooLang::Objs::Text )
